# APEIRIA Project Page

Static GitHub Pages project page for:

> Distilling Neuro-Symbolic Programs into 3D Multi-modal LLMs

Open `index.html` directly or publish this `project-page/` directory as the GitHub Pages source.
...
The compiled manuscript is included at `assets/paper.pdf` and linked from the
hero section.
